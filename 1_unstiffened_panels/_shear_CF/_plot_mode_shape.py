...
ax.plot_surface(X1, X2, Wflat, cmap=cm.coolwarm,
                       linewidth=0, alpha=0.5, antialiased=False, zorder=0.5)

ax.plot_surface(X1, X2, W, cmap=cm.coolwarm,
...
if args.show:
    plt.show()
ax.view_init(elev=40., azim=-90-10)
