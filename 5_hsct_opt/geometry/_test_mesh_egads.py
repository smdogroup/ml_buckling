...
if comm.rank == 0:
    ...
    egads_tess_aim.input.Mesh_Sizing = {
        ...
        "wingMesh": {"tessParams": [0.1, 0.1, 15.0], "Edge_Point_Min" : 20, "Edge_Point_Max" : 50},
        "rootEdgeMesh": {
        "numEdgePoints": 80,
...
if case == "inviscid":
    ...
    mesh_aim.volume_aim.set_boundary_layer(
        initial_spacing=1e-5, max_layers=55, thickness=20e-5, use_quads=True
    )
