...
parent_parser.add_argument("--nstiff", type=int, default=9)
...
parent_parser.add_argument(
    "--orthotropic", default=True, action=argparse.BooleanOptionalAction
)
parent_parser.add_argument(
...
parent_parser.add_argument("--rho0", type=float, default=0.5)
parent_parser.add_argument("--gamma", type=float, default=3.0)
