...
# save the figure
fs1 = 16
ax.set_xlabel(r"$\mathbf{\ln(x_1^*)}$", fontsize=fs1, fontweight='bold')
ax.set_ylabel(r"$\mathbf{\ln(x_2^*)}$", fontsize=fs1, fontweight='bold')
if args.load == "Nx":
    ax.set_zlabel(r"$\mathbf{\ln(N_{ij,cr}^*)}$", fontsize=fs1, fontweight='bold')
else:
