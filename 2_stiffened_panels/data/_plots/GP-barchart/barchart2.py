...
data = {
    ...
    "R2_Axial_Extrap": [0.5270, 0.5269, 0.5082, -0.0580, -0.0723, 0.042,
    ...
    "R2_Shear_Extrap": [0.9499, 0.9510, 0.04, 0.0298, 0.1758, 0.0437,
...
#     x_positions = np.arange(len(x_labels))
    ...
    # Plot Axial 
    ax.bar(bar_positions - 1.5*bar_width, axial["Interp"], bar_width, 
           label="Axial Interp", color=colors[0])
    ax.bar(bar_positions - 0.5*bar_width, axial["Extrap"], bar_width, 
           label="Axial Extrap", color=colors[2])

    # Plot Shear 
    ax.bar(bar_positions + 0.5 * bar_width, shear["Interp"], bar_width, 
           label="Shear Interp", color=colors[4])
    ax.bar(bar_positions + 1.5 * bar_width, shear["Extrap"], bar_width, 
          label="Shear Extrap", color=colors[5])
