...
component_groups = [group for group in component_groups if "OMLtop" in group]
...
comp_groups = ["OMLtop", "OMLbot", "LEspar", "TEspar"] + [
    f"spar{ispar}" for ispar in range(1, nspars + 1)
]
