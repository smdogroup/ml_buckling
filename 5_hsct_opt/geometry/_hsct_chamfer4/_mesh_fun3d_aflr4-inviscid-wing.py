...
for aim in [fun3d_aim, aflr3_aim, aflr4_aim]:
    aim.input.Proj_Name = "hsct-inviscid"
...
aflr4_aim.input.EGADS_Quad = False #True, was really slow at building EGADS Quadding
...
aflr3_aim.input.BL_Initial_Spacing = 0.0055
aflr3_aim.input.BL_Thickness = 1e-2
