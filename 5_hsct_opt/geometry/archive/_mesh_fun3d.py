...
if case == "inviscid":
    ...
    aflr_aim.set_boundary_layer(
        initial_spacing=0.005, max_layers=35, thickness=0.01, use_quads=True
    )
...
FluidMeshOptions["aflr4AIM"]["Mesh_Sizing"] = {
    ...
    "fuselageMidEdgeMesh": {"scaleFactor": 1, "max_scale": 10},
    "rootEdgeMesh": {"scaleFactor": 0.5},
    "wingMesh": {"scaleFactor": 1.0, "AFLR4_quad_local": 0.0, "min_scale": global_min},
    "staticWingMesh": {"scaleFactor": 0.8},
    "fuselageMesh": {"edgeWeight": 1.0, "AFLR4_quad_local": 1.0, "scaleFactor": 0.4},
}
