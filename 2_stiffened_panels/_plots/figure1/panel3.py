...
parent_parser.add_argument("--rho0", type=float, default=3.2)
parent_parser.add_argument("--gamma", type=float, default=0.2)
...
if args.orthotropic:
    plate_material = mlb.CompositeMaterial.hexcelIM7(
