...
T_inf = 216  # Freestream temperature
q_inf = 3.1682e4  # Dynamic pressure

# Construct the FUNtoFEM model
f2f_model = FUNtoFEMmodel("1-hsct-sizing")
...
design_out_file = os.path.join(base_dir, "design", "1-design.txt")

design_folder = os.path.join(base_dir, "design")
if comm.rank == 0:
    if not os.path.exists(design_folder):
        os.mkdir(design_folder)
history_file = os.path.join(design_folder, "1-design.hst")
